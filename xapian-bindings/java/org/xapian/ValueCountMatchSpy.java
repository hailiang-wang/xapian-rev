...
public class ValueCountMatchSpy extends MatchSpy {
  ...
  protected ValueCountMatchSpy(long cPtr, boolean cMemoryOwn) {
    super(XapianJNI.ValueCountMatchSpy_SWIGUpcast(cPtr), cMemoryOwn);
    swigCPtr = cPtr;
  }

  protected static long getCPtr(ValueCountMatchSpy obj) {
  ...
  public void mergeResults(byte[] serialised) {
    XapianJNI.ValueCountMatchSpy_mergeResults(swigCPtr, this, serialised);
  }
