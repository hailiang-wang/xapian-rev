...
public class Compactor {
  ...
  protected Compactor(long cPtr, boolean cMemoryOwn) {
    swigCMemOwn = cMemoryOwn;
    swigCPtr = cPtr;
  }

  protected static long getCPtr(Compactor obj) {
  ...
  public final static class compaction_level {
    public final static Compactor.compaction_level STANDARD = new Compactor.compaction_level("STANDARD", XapianJNI.Compactor_STANDARD_get());
    public final static Compactor.compaction_level FULL = new Compactor.compaction_level("FULL", XapianJNI.Compactor_FULL_get());
    public final static Compactor.compaction_level FULLER = new Compactor.compaction_level("FULLER", XapianJNI.Compactor_FULLER_get());
