...
public class QueryParser {
  ...
  public void addBooleanPrefix(String field, String prefix, SWIGTYPE_p_std__string grouping) {
    XapianJNI.QueryParser_addBooleanPrefix__SWIG_0(swigCPtr, this, field, prefix, SWIGTYPE_p_std__string.getCPtr(grouping));
  }
  ...
  public void addBooleanPrefix(String field, FieldProcessor proc, SWIGTYPE_p_std__string grouping) {
    XapianJNI.QueryParser_addBooleanPrefix__SWIG_3(swigCPtr, this, field, FieldProcessor.getCPtr(proc), proc, SWIGTYPE_p_std__string.getCPtr(grouping));
  }
  ...
  public void addRangeprocessor(RangeProcessor range_proc, SWIGTYPE_p_std__string grouping) {
    XapianJNI.QueryParser_addRangeprocessor__SWIG_0(swigCPtr, this, RangeProcessor.getCPtr(range_proc), range_proc, SWIGTYPE_p_std__string.getCPtr(grouping));
  }
  ...
  public final static class feature_flag {
    ...
    private static feature_flag[] swigValues = { FLAG_BOOLEAN, FLAG_PHRASE, FLAG_LOVEHATE, FLAG_BOOLEAN_ANY_CASE, FLAG_WILDCARD, FLAG_PURE_NOT, FLAG_PARTIAL, FLAG_SPELLING_CORRECTION, FLAG_SYNONYM, FLAG_AUTO_SYNONYMS, FLAG_AUTO_MULTIWORD_SYNONYMS, FLAG_CJK_NGRAM, FLAG_DEFAULT };
