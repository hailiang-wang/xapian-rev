...
public:
    SwigDirector_StemImplementation(zval *self TSRMLS_DC);
...
public:
    SwigDirector_MatchDecider(zval *self TSRMLS_DC);
...
public:
    SwigDirector_ExpandDecider(zval *self TSRMLS_DC);
...
public:
    SwigDirector_KeyMaker(zval *self TSRMLS_DC);
...
public:
    SwigDirector_Stopper(zval *self TSRMLS_DC);
    virtual bool operator ()(std::string const &term) const;
...
public:
    SwigDirector_RangeProcessor(zval *self TSRMLS_DC);
    SwigDirector_RangeProcessor(zval *self TSRMLS_DC, Xapian::valueno slot_, std::string const &str_ = std::string(), unsigned int flags_ = 0);
...
public:
    SwigDirector_ValueRangeProcessor(zval *self TSRMLS_DC);
...
public:
    SwigDirector_FieldProcessor(zval *self TSRMLS_DC);
...
public:
    SwigDirector_Compactor(zval *self TSRMLS_DC);
...
public:
    SwigDirector_PostingSource(zval *self TSRMLS_DC);
...
public:
    SwigDirector_ValuePostingSource(zval *self TSRMLS_DC, Xapian::valueno slot_);
...
public:
    SwigDirector_ValueWeightPostingSource(zval *self TSRMLS_DC, Xapian::valueno slot_);
...
public:
    SwigDirector_MatchSpy(zval *self TSRMLS_DC);
...
public:
    SwigDirector_LatLongMetric(zval *self TSRMLS_DC);
