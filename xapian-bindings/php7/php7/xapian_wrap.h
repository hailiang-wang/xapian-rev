...
public:
    SwigDirector_StemImplementation(zval *self);
...
public:
    SwigDirector_MatchDecider(zval *self);
...
public:
    SwigDirector_ExpandDecider(zval *self);
...
public:
    SwigDirector_KeyMaker(zval *self);
...
public:
    SwigDirector_Stopper(zval *self);
    virtual bool operator ()(std::string const &term) const;
...
public:
    SwigDirector_RangeProcessor(zval *self);
    SwigDirector_RangeProcessor(zval *self, Xapian::valueno slot_, std::string const &str_ = std::string(), unsigned int flags_ = 0);
...
public:
    SwigDirector_ValueRangeProcessor(zval *self);
...
public:
    SwigDirector_FieldProcessor(zval *self);
...
public:
    SwigDirector_Compactor(zval *self);
...
public:
    SwigDirector_PostingSource(zval *self);
...
public:
    SwigDirector_ValuePostingSource(zval *self, Xapian::valueno slot_);
...
public:
    SwigDirector_ValueWeightPostingSource(zval *self, Xapian::valueno slot_);
...
public:
    SwigDirector_MatchSpy(zval *self);
...
public:
    SwigDirector_LatLongMetric(zval *self);
