...
public:
    SwigDirector_RangeProcessor();
    SwigDirector_RangeProcessor(Xapian::valueno slot_, std::string const &str_ = std::string(), unsigned int flags_ = 0);
...
public:
    SwigDirector_ValuePostingSource(Xapian::valueno slot_);
...
public:
    SwigDirector_ValueWeightPostingSource(Xapian::valueno slot_);
...
public:
    ...
    typedef double (SWIGSTDCALL* SWIG_Callback0_t)(void *, void *);
    typedef char * (SWIGSTDCALL* SWIG_Callback1_t)();
    void swig_connect_director(SWIG_Callback0_t callbackPointwiseDistance, SWIG_Callback1_t callbackName);

private:
    SWIG_Callback0_t swig_callbackPointwiseDistance;
    SWIG_Callback1_t swig_callbackName;
    void swig_init_callbacks();
};
